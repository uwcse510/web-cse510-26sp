...
Students will sign up to collaborate in group presentation assigned readings and facilitation of in-class discussion.
...
(e.g., missing class due to illness),
other presenters are expected to be familiar with and prepared to deliver the presentation.

Small-group discussions will then be facilitated by presenters and any additional facilitators who have signed up for this role.
...
- Approximately 1 minute to introduce the day’s research topic and any research guest.
...
- Approximately 7 minutes for each assigned reading:
  ...
  - Brief acknowledgement of the authors and any notable background.
    ...
    (e.g., background other students might want if they encountered a prominent author at a conference).
...
- Approximately 3 minutes introducing a range of key connections and opportunities for discussion.
  ...
  Briefly introduce at least 4 distinct directions people might explore in small-group discussions. 
  These should be based on observations in or across the assigned readings, 
  and we encourage you to draw upon insights shared in discussion posts. 
  Your goal is to help people see multiple opportunities for meaningful discussion.
  These should be on a single slides that can be displayed during small-group discussions.
...
Presentations will be followed by approximately 20 minutes of student-led small-group discussion.

Students will self-organize into small groups.
...
The facilitator of each small group is then responsible for contributing a question or discussoin point from the group to the larger class.
These should explore topics that a group and a facilitator feel will benefit from larger discussion
(e.g., because a group found a question interesting but was unsure how to approach it,
because a group had a compelling discussion they want to share,
because a group seeks additional perspective around a discussion).
As discussions are raised by each small group,
facilitators are additionally responsible for ensuring that each raises a distinct discussion
(e.g., if a group raises a discussion that a facilitator had planned to raise,
that facilitator is responsible for choosing a different discussion to raise).

The class will use a shared document for facilitators and groups to track participation and draft potential discussion items.
Facilitators may choose to pre-populate this document with potential discussions if this will help them feel more comfortable with this responsibility.
...
- Presentations will be prepared in a shared Slides deck.
- Facilitation of small-group discussion will also use a shared document.
...
presentation groups are required to submit a near-complete PDF of the combined presentation Slides deck by 8:00pm two days before class
(i.e., Sunday 8:00pm for a Tuesday class, Tuesday 8:00pm for a Thursday class).
Slides are expected to be complete, except they may still be missing the final section on opportunities for discussion
(i.e., understanding that presenters may want to prepare these slides after the discussion post deadline of the day before class).
...
### Presentation Group Contribution Feedback
